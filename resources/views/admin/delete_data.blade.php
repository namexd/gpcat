...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-dialog" role="document">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group">
                                <div class="form-group">
                                    <label>供应商</label>
                                    <input type="text" id="supplier" name="supplier" value="" class="form-control supplier action"
                                           placeholder="输入 供应商">
                                </div>
                                <div class="form-group">
                                    <label>仓库名称</label>
                                    <input type="text" id="repository" name="repository" value=""
                                           class="form-control repository action" placeholder="输入 仓库名称">
                                </div>
                                <div class="form-group">
                                    <label>备用字段1</label>
                                    <input type="text" id="extra1" name="extra1" value="" class="form-control extra1 action"
                                           placeholder="输入 备用字段1">
                                </div>
                                <div class="form-group">
                                    <label>备用字段2</label>
                                    <input type="text" id="extra2" name="extra2" value="" class="form-control extra2 action"
                                           placeholder="输入 备用字段2">
                                </div>
                                <div class="form-group">
                                    <label>导入时间</label>
                                ...
                                <div class="form-group">
                                    <label>更新时间</label>
                                    <input type="text" id="updated_at" name="updated_at" class="form-control updated_at action"
                                           placeholder="选择更新时间">
                                </div>
                            </div><!-- /input-group -->
                        </div><!-- /.col-lg-6 -->
        ...
        <script>
            $(function () {
                $("#arrange_time").datetimepicker({format: "YYYY-MM-DD HH:mm:ss", locale: "zh-CN"});
                $("#updated_at").datetimepicker({format: "YYYY-MM-DD HH:mm:ss", locale: "zh-CN"});
            });
